...
const documentScore = async (jobDescription, resumeSections) => {
  ...
  if (resumeSections.experience) {
    resumeText += " " + resumeSections.experience;
  }
  if (resumeSections.projects) {
    resumeText += " " + resumeSections.projects;
  }
  if (resumeSections.internship) {
    resumeText += " " + resumeSections.internship;
  }
